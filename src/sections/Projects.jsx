    ...
    return (
        <section id="projects" className="py-32 relative overflow-hidden">
            ...
            <div className="absolute top-1/4 right-0 w-96 h-96 bg-primary/5 rounded-full blur-3xl">
                <div className="absolute top-1/4 left-0 w-96 h-96 bg-highlight/5 rounded-full blur-3xl"></div>
                <div className="container mx-auto px-6 relative z-10"></div>
                {/* Section Header */}
                <div className="text-center mx-auto max-w-3xl mb-16">
                    <span className="text-secondary-foreground text-sm font-medium tracking-wider uppercase animate-fade-in">Project Portfolio</span>
                    ...
                    <p className="text-muted-foreground animate-fade-in animation-delay-200">
                        Here's a small selection of projects that showcase my skills and experience in web development. Each project reflects my dedication to creating efficient, user-friendly, and visually appealing applications.
                    </p>
                </div>
                {/* Projects Grid */}
