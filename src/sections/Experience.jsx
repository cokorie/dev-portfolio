const experiences = [
    ...
    {
        period: "2021",
        role: "Software Engineer Immersive",
        ...
        <section id="experience" className="py-32 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="max-w-3xl mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold mt-6 mb-6 animate-fade-in animation-delay-100 text-secondary-foreground">Professional Experience {" "}
                        <span className="font-serif italic font-normal text-white">{" "}speaking volumes.</span>
                    </h2>
                    <p className="text-muted-foreground animate-fade-in animation-delay-200">
                        Over the years, I've had the privilege of working with some incredible companies and teams. Each experience has contributed to my growth as a developer and shaped my approach to building impactful software solutions.
                    </p>
                </div>
                {/* Experience Timeline */}
